...
public class ClientPanel extends JPanel {
    ...
    public ClientPanel(final Car driver) {
        ...
        rdbtnNewRadioButton_2.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent arg0) {
                if (sendUpdate(CarUtil.createDriverStatePostRequestJsonString(driver.getID(), Car.State.FREE,
                        new String[] { "", "", "", "" })).contains("400 Wrong Json String")) {
                    System.err.println("Wrong request.");
                }
        ...
        button_OverviewDesUpdate.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                if (driver.getState() == Car.State.FREE || driver.getState() == Car.State.INACTIVE) {
                    driver.setDestinationAddress(
                            new String[] { textField_OverviewDesHnr.getText(), textField_OverviewDesStreet.getText(),
                                    textField_OverviewDesCity.getText(), textField_OverviewDesCountry.getText() });
                } else {
